    ...
    <header className="container mx-auto px-6 py-8 md:py-12 border-b border-gray-200 max-w-6xl w-full shrink-0">
      <nav className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-6">
          ...
          <a href="/redirect-to-landing-page" className="px-6 py-3 bg-ink-navy text-white font-bold uppercase tracking-widest text-sm transition-all hover:bg-jade-green hidden sm:block">
            Try Provd
          </a>
        </div>
      </nav>
